---
sidebar_position: 4
slug: ../advanced-topics/color-palettes
---
...
Color improves a chart's aesthetic quality, as well as its ability to effectively communicate about its data. The colors used for data visualization can generally be classified into three palettes. Read more [here](https://spectrum.adobe.com/page/color-for-data-visualization/).

![Color palettes](/img/developer/advanced-topics/color-palettes.png)